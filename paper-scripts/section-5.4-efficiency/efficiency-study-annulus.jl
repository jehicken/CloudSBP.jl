module EfficiencyStudyAnnulus
# Gather data for efficiency of cloud-SBP operators on the annulus 
...
# write the solution to file for plotting
f = open("efficiency-annulus.dat", "w")
for d in axes(deg,1)
